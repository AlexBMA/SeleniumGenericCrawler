...
class ZiareComAddsHomePage(HelperClass):
    ...
    def get_home_page_ads(self):

        list_add_links = []

        self.get_top_ads(list_add_links)

        self.get_right_add(list_add_links)
    ...
    def get_right_add(self, list_adds_src):
        ...
        try:
            list_adds_src.append(self.right_add_scenario_46())
        except Exception as ex:
        ...
        try:
            list_adds_src.append(self.right_add_scenario_59())
        except Exception as ex:
    ...
    def right_add_scenario_46(self):
    ...
    def right_add_scenario_59(self):
    ...
    def scenario_63(self):
        ...
        print("screenshot taken in scenario 63")

    def scenario_64(self):
        print("scenario 64")
        ...
        div_with_add = self.browser.find_element_by_id("ad-container")
        self.screenshot(element=div_with_add,path=self.path)
        print("screenshot taken in scenario 64")

    def scenario_65(self):
        print("scenario 65")
