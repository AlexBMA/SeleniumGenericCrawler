...
class ZaireComAddsArticlePage(HelperClass):
    list_add_screenshot = []
    ...
    def get_article_ads(self):

        list_adds_src = []

        self.top_add(list_adds_src)

        self.get_right_add(list_adds_src)

        self.get_middle_add(list_adds_src)

        self.get_bottom_add(list_adds_src)

        return self.eliminate_duplicate(list_adds_src)

    def get_bottom_add(self, list_adds_src):

        try:
            list_adds_src.append(self.get_bottom_add_scenario_1())
        ...
        try:
            list_adds_src.append(self.get_bottom_add_scenario_2())
        except Exception as ex:
        ...
        try:
            list_adds_src.append(self.get_bottom_add_scenario_3())
        except Exception as ex:
        ...
        try:
            list_adds_src.append(self.get_bottom_add_scenario_4())
        except Exception as ex:
        ...
        try:
            list_adds_src.append(self.get_bottom_add_scenario_5())
        except Exception as ex:
            print("no add in scenario 5")
            print("Exception {}".format(ex))
            pass

    def get_middle_add(self, list_adds_src):

        try:
            list_adds_src.append(self.get_mid_add_scenario_1())
        except Exception as ex:
            print("no add in scenario 1")
            print("Exception {}".format(ex))
            pass
        ...
        try:
            list_adds_src.append(self.get_mid_add_scenario_2())
        except Exception as ex:
            print("no add in scenario 2")
            print("Exception {}".format(ex))
            pass
        ...
        try:
            list_adds_src.append(self.get_mid_add_scenario_3())
        except Exception as ex:
            print("no add in scenario 3")
            print("Exception {}".format(ex))
            pass
        ...
        try:
            list_adds_src.append(self.get_mid_add_scenario_4())
        except Exception as ex:
            print("no add in scenario 4")
            print("Exception {}".format(ex))
            pass
        ...
        try:
            list_adds_src.append(self.get_mid_add_scenario_5())
        except Exception as ex:
            print("no add in scenario 5")
            print("Exception {}".format(ex))
            pass
        ...
        try:
            list_adds_src.append(self.get_mid_add_scenario_6())
        except Exception as ex:
        ...
        try:
            list_adds_src.append(self.get_mid_add_scenario_7())
        except Exception as ex:
        ...
        try:
            list_adds_src.append(self.get_mid_add_scenario_8())
        except Exception as ex:
        ...
        try:
            list_adds_src.append(self.get_mid_add_scenario_9())
        except Exception as ex:
        ...
        try:
            list_adds_src.append(self.get_mid_add_scenario_10())
        except Exception as ex:
        ...
        try:
            list_adds_src.append(self.get_mid_add_scenario_11())
        except Exception as ex:
    ...
    def get_right_add(self, list_adds_src):
        ...
        try:
            list_adds_src.append(self.right_add_scenario_1())
        except Exception as ex:
            print("no add in scenario 1")
            print("Exception {}".format(ex))

        try:
            list_adds_src.append(self.right_add_scenario_2())
        except Exception as ex:
            print("no add in scenario 2")
            print("Exception {}".format(ex))
            pass
        ...
        try:
            list_adds_src.append(self.right_add_scenario_3())
        except Exception as ex:
            print("no add in scenario 3")
            print("Exception {}".format(ex))
            pass
        ...
        try:
            list_adds_src.append(self.right_add_scenario_4())
        except Exception as ex:
            print("no add in scenario 4")
            print("Exception {}".format(ex))
            pass
        ...
        try:
            list_adds_src.append(self.right_add_scenario_5())
        except Exception as ex:
            print("no add in scenario 5")
            print("Exception {}".format(ex))
            pass
        ...
        try:
            list_adds_src.append(self.right_add_scenario_6())
        except Exception as ex:
            print("no add in scenario 6")
            print("Exception {}".format(ex))
            pass
        ...
        try:
            list_adds_src.append(self.right_add_scenario_7())
        except Exception as ex:
            print("no add in scenario 7")
            print("Exception {}".format(ex))
            pass
        ...
        try:
            list_adds_src.append(self.right_add_scenario_8())
        except Exception as ex:
            print("no add in scenario 8")
            print("Exception {}".format(ex))
            pass
        ...
        try:
            list_adds_src.append(self.right_add_scenario_9())
        except Exception as ex:
            print("no add in scenario 9")
            print("Exception {}".format(ex))
            pass
        ...
        try:
            list_adds_src.append(self.right_add_scenario_10())
        except Exception as ex:
            print("no add in scenario 10")
            print("Exception {}".format(ex))
            pass
        ...
        try:
            list_adds_src.append(self.right_add_scenario_11())
        except Exception as ex:
            print("no add in scenario 11")
            print("Exception {}".format(ex))
            pass
        ...
        try:
            list_adds_src.append(self.right_add_scenario_12())
        except Exception as ex:
        ...
        try:
            list_adds_src.append(self.right_add_scenario_13())
        except Exception as ex:
        ...
        try:
            list_adds_src.append(self.right_add_scenario_14())
        except Exception as ex:
        ...
        try:
            list_adds_src.append(self.right_add_scenario_15())
        except Exception as ex:
        ...
        try:
            list_adds_src.append(self.right_add_scenario_16())
        except Exception as ex:
        ...
        try:
            list_adds_src.append(self.right_add_scenario_17())
        except Exception as ex:
        ...
        try:
            list_adds_src.append(self.right_add_scenario_18())
        except Exception as ex:
        ...
        try:
            list_adds_src.append(self.right_add_scenario_19())
        except Exception as ex:
        ...
        try:
            list_adds_src.append(self.right_add_scenario_20())
        except Exception as ex:
        ...
        try:
            list_adds_src.append(self.right_add_scenario_21())
        except Exception as ex:
        ...
        try:
            list_adds_src.append(self.right_add_scenario_22())
        except Exception as ex:
        ...
        try:
            list_adds_src.append(self.right_add_scenario_23())
        except Exception as ex:
        ...
        try:
            list_adds_src.append(self.right_add_scenario_24())
        except Exception as ex:
        ...
        try:
            list_adds_src.append(self.right_add_scenario_25())
        except Exception as ex:
        ...
        try:
            list_adds_src.append(self.right_add_scenario_26())
        except Exception as ex:
        ...
        try:
            list_adds_src.append(self.right_add_scenario_27())
        except Exception as ex:
        ...
        try:
            list_adds_src.append(self.right_add_scenario_28())
        except Exception as ex:
        ...
        try:
            list_adds_src.append(self.right_add_scenario_29())
        except Exception as ex:
        ...
        try:
            list_adds_src.append(self.right_add_scenario_30())
        except Exception as ex:
        ...
        try:
            list_adds_src.append(self.right_add_scenario_31())
        except Exception as ex:
            print("no add in scenario 31")
            print("Exception {}".format(ex))
            pass
        try:
            list_adds_src.append(self.right_add_scenario_32())
        except Exception as ex:
        ...
        try:
            list_adds_src.append(self.right_add_scenario_33())
        except Exception as ex:
        ...
        try:
            list_adds_src.append(self.right_add_scenario_34())
        except Exception as ex:
        ...
        try:
            list_adds_src.append(self.right_add_scenario_35())
        except Exception as ex:
        ...
        try:
            list_adds_src.append(self.right_add_scenario_36())
        except Exception as ex:
            print("no add in scenario 36")
            print("Exception {}".format(ex))
            pass
        try:
            list_adds_src.append(self.right_add_scenario_37())
        except Exception as ex:
        ...
        try:
            list_adds_src.append(self.right_add_scenario_38())
        except Exception as ex:
        ...
        try:
            list_adds_src.append(self.right_add_scenario_39())
        except Exception as ex:
        ...
        try:
            list_adds_src.append(self.right_add_scenario_40())
        except Exception as ex:
        ...
        try:
            list_adds_src.append(self.right_add_scenario_41())
        except Exception as ex:
        ...
        try:
            list_adds_src.append(self.right_add_scenario_42())
        except Exception as ex:
        ...
        try:
            list_adds_src.append(self.right_add_scenario_43())
        except Exception as ex:
        ...
        try:
            list_adds_src.append(self.right_add_scenario_44())
        except Exception as ex:
        ...
        try:
            list_adds_src.append(self.right_add_scenario_45())
        except Exception as ex:
        ...
        try:
            list_adds_src.append(self.right_add_scenario_47())
        except Exception as ex:
        ...
        try:
            list_adds_src.append(self.right_add_scenario_48())
        except Exception as ex:
        ...
        try:
            list_adds_src.append(self.right_add_scenario_49())
        except Exception as ex:
        ...
        try:
            list_adds_src.append(self.right_add_scenario_50())
        except Exception as ex:
            print("no add in scenario 50")
            print("Exception {}".format(ex))
            pass
        try:
            list_adds_src.append(self.right_add_scenario_51())
        except Exception as ex:
            print("no add in scenario 51")
            print("Exception {}".format(ex))
            pass
        try:
            list_adds_src.append(self.right_add_scenario_52())
        except Exception as ex:
        ...
        try:
            list_adds_src.append(self.right_add_scenario_53())
        except Exception as ex:
        ...
        try:
            list_adds_src.append(self.right_add_scenario_54())
        except Exception as ex:
        ...
        try:
            list_adds_src.append(self.right_add_scenario_55())
        except Exception as ex:
        ...
        try:
            list_adds_src.append(self.right_add_scenario_56())
        except Exception as ex:
        ...
        try:
            list_adds_src.append(self.right_add_scenario_57())
        except Exception as ex:
        ...
        try:
            list_adds_src.append(self.right_add_scenario_58())
        except Exception as ex:
            print("no add in scenario 58")
            print("Exception {}".format(ex))
            pass

    def right_add_scenario_1(self):
    ...
    def right_add_scenario_10(self):
    ...
    def right_add_scenario_11(self):
        ...
        print("screenshot taken in scenario 11")

    def right_add_scenario_12(self):
    ...
    def right_add_scenario_13(self):
        ...
        print("screenshot taken in scenario 13")

    def right_add_scenario_14(self):
    ...
    def right_add_scenario_15(self):
    ...
    def right_add_scenario_16(self):
    ...
    def right_add_scenario_17(self):
    ...
    def right_add_scenario_18(self):
    ...
    def right_add_scenario_19(self):
    ...
    def right_add_scenario_20(self):
    ...
    def right_add_scenario_21(self):

        print("Right add scenario 21")
        ...
        print("screenshot taken in scenario 21")

    def right_add_scenario_22(self):
    ...
    def right_add_scenario_23(self):

        print("Right add scenario_23")
    ...
    def right_add_scenario_24(self):
    ...
    def right_add_scenario_25(self):
    ...
    def right_add_scenario_26(self):
    ...
    def right_add_scenario_27(self):
        ...
        print("screenshot taken in scenario 27")

    def right_add_scenario_28(self):
    ...
    def right_add_scenario_29(self):
    ...
    def right_add_scenario_30(self):
    ...
    def right_add_scenario_31(self):
    ...
    def right_add_scenario_32(self):
    ...
    def right_add_scenario_33(self):
    ...
    def right_add_scenario_34(self):
        ...
        print("screenshot taken in scenario 34")

    def right_add_scenario_35(self):
    ...
    def right_add_scenario_36(self):
    ...
    def right_add_scenario_37(self):
    ...
    def right_add_scenario_38(self):
    ...
    def right_add_scenario_39(self):
    ...
    def right_add_scenario_40(self):
    ...
    def right_add_scenario_41(self):
        ...
        print("screenshot taken in scenario 41")

    def right_add_scenario_42(self):

        print("Right add scenario 42")
    ...
    def right_add_scenario_43(self):
    ...
    def right_add_scenario_44(self):
        ...
        print("screenshot taken in scenario 44")

    def get_mid_add_scenario_1(self):
        print("Mid add scenario 1")

        self.browser.switch_to.default_content()

        right_side_div = self.browser.find_element_by_xpath("//div[@Class='banner fleft']")
        ...
        # google_ads_frame2
        iframe_in_iframe = self.browser.find_element_by_id("google_ads_frame2")
        self.browser.switch_to.frame(iframe_in_iframe)
    ...
    def get_mid_add_scenario_2(self):
        ...
        # ad_iframe
        iframe_in_iframe_in_iframe = self.browser.find_element_by_id("ad_iframe")
        self.browser.switch_to.frame(iframe_in_iframe_in_iframe)
    ...
    def get_mid_add_scenario_3(self):

        print("Mid add scenario 3")
        ...
        print("screenshot taken in scenario 3")

    def get_mid_add_scenario_4(self):

        print("Mid add scenario 4")
    ...
    def get_mid_add_scenario_5(self):

        print("Mid add scenario 5")
        ...
        div_with_add = self.browser.find_element_by_id("adunit")
        # taw0
        li_add = div_with_add.find_element_by_id("taw0")
        self.screenshot(element=li_add, path=self.path)

        print("screenshot taken in scenario 5")

    def get_mid_add_scenario_6(self):

        print("Mid add scenario 6")
    ...
    def get_bottom_add_scenario_1(self):

        print("Bottom add scenario 1")

        self.browser.switch_to.default_content()

        right_side_div = self.browser.find_element_by_xpath("//div[@Class='fleft']")
    ...
    def get_bottom_add_scenario_2(self):

        print("Bottom add scenario 2")
    ...
    def right_add_scenario_45(self):
    ...
    def get_mid_add_scenario_7(self):
        print("Mid add scenario 7")
    ...
    def right_add_scenario_47(self):
    ...
    def right_add_scenario_48(self):
    ...
    def right_add_scenario_49(self):
    ...
    def right_add_scenario_50(self):
    ...
    def get_mid_add_scenario_8(self):
        print("Mid add scenario 8")
    ...
    def right_add_scenario_51(self):
        ...
        print("screenshot taken in scenario 51")

    def get_bottom_add_scenario_3(self):

        print("Bottom add scenario 3")
    ...
    def right_add_scenario_52(self):

        print("Right add scenario 52")
    ...
    def right_add_scenario_53(self):

        print("Right add scenario 53")
    ...
    def right_add_scenario_54(self):

        print("Right add  scenario 54")
        ...
        print("screenshot taken in scenario 54")

    def right_add_scenario_55(self):

        print("Right add scenario 55")
    ...
    def scenario_72(self):
        ...
        div_with_add = self.browser.find_element_by_id("adContent")
        self.screenshot(element=div_with_add, path=self.path)
        print("screenshot taken in scenario 72")

    def right_add_scenario_56(self):
        ...
        li_with_add = div_with_add.find_element_by_id("taw0")
        self.screenshot(element=li_with_add, path=self.path)
        print("screenshot taken in scenario 56")

    def get_mid_add_scenario_9(self):
        print("Mid add scenario 9")
    ...
    def get_bottom_add_scenario_4(self):

        print("Bottom add scenario 4")
    ...
    def right_add_scenario_57(self):
        ...
        print("scrrenshot taken in scenario 57")

    def right_add_scenario_58(self):
        ...
        print("screenshot taken in scenario 58")

    def get_bottom_add_scenario_5(self):
        print("Buttom add scenario 5")
    ...
    def get_mid_add_scenario_10(self):
        print("Mid add scenario 10")
        ...
        # ad_frame
        iframe_in_iframe_in_iframe = self.browser.find_element_by_id("ad_frame")
        self.browser.switch_to.frame(iframe_in_iframe_in_iframe)

        iframe_in_iframe_in_iframe_in_iframe = self.browser.find_element_by_tag_name("iframe")
        self.browser.switch_to.frame(iframe_in_iframe_in_iframe_in_iframe)

        self.screenshot(element=iframe_in_iframe_in_iframe_in_iframe, path=self.path)

        print("screenshot taken in scenario 10")

    def get_mid_add_scenario_11(self):
        print("Mid add scenario 11")
    ...
    def scenario_82(self):
        ...
        self.screenshot(element=iframe_in_iframe, path=self.path)

        print("screenshot taken in scenario 82")
    ...
    def top_add(self, list_adds_src):
        ...
        try:
            list_adds_src.append(self.top_add_scenario_6())
        except Exception as ex:
            print("no add in scenario 6")
            print("Exception {}".format(ex))
            pass
        ...
        try:
            list_adds_src.append(self.top_add_scenario_7())
        except Exception as ex:
            print("no add in scenario 7")
            print("Exception {}".format(ex))
            pass
    ...
    def top_add_scenario_7(self):
        ...
        div = self.browser.find_element_by_id("branding_top_d93jgxa3")
        div2 = div.find_element_by_xpath("//div[starts-with(@id,,'PEC-')]")

        div3 = div2.find_element_by_tag_name("div")
        img = div3.find_element_by_tag_name("img")
        src = img.get_attribute("src")
    ...
    def top_add_scenario_2(self):
        ...
        div = self.browser.find_element_by_id("id_boom_top")
        ...
        # google_image_div
        div_with_img = self.browser.find_element_by_id("google_image_div")
        self.screenshot(element=div_with_img, path=self.path)
        print("screenshot taken in scenario 2")
    ...
    def top_add_scenario_5(self):
        ...
        # aswift_1
        iframe = div.find_element_by_id("aswift_1")
        self.browser.switch_to.frame(iframe)
        ...
        # root_template_div
        div_with_add = self.browser.find_element_by_id("root_template_div")
        self.screenshot(element=div_with_add, path=self.path)

        print("screenshot taken in sceanrio 5")
